...
export class ProductCategoryController {
  ...
  @ApiBadRequestResponse({
    description: 'Failed to create the Product Category',
  })
  @Post()
  ...
  @ApiBadRequestResponse({
    description: 'Failed to update the Product Category',
  })
  @Patch(':id')
  async update(
    @Param('id') id: string,
    ...
    return this.productCategoriesService.updateAProductCategory(
      +id,
  ...
  @ApiBadRequestResponse({
    description: 'Failed to delete the Product Category',
  })
  @Delete(':id')
